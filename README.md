...
SELECT * FROM Turno;
```
*Los scripts utilzados al momento de crear las tablas e insertar datos están en los archivos adjuntos al repositorio `creacion_tablas.sql` e `insercion_datos.sql`*
